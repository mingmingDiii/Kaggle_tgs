...
from main_code_torch.models.pre_models.common2 import senet


class MSENET(nn.Module):
    def __init__(self,pretrained=True,reduction=2):
        super().__init__()
        self.basenet = senet.senet154(pretrained='imagenet')

        self.conv1 = self.basenet.layer0
        ...
        self.decoder5 = Decoder(256+512,256,64,reduction)
        self.decoder4 = Decoder(64+256,128,64,reduction)
        self.decoder3 = Decoder(64+128,64,64,reduction)
    ...
    def forward(self, x):
        ...
        e1 = self.conv1(x)  #; print('x',x.size())    #128,64,64

        e2 = self.encoder2(e1) #; print('e2',e2.size()) #256,32,32


        e3 = self.encoder3(e2) #; print('e3',e3.size())#512,16,16

        e4 = self.encoder4(e3)#; print('e4',e4.size()) #1024,8,8

        #e5 = self.encoder5(e4)# ; print('e5',e5.size())#2048,4,4
