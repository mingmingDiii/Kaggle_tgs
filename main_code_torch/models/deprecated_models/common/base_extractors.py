...
# def load_weights_sequential_ori(target, source_state):
#     new_dict = OrderedDict()
#     for (k1, v1), (k2, v2) in zip(target.state_dict().items(), source_state.items()):
#         new_dict[k1] = v2
#     target.load_state_dict(new_dict)
# 
# def load_weights_sequential_work(target, source_state):
#     new_dict = OrderedDict()
#     for (k1, v1), (k2, v2) in zip(target.state_dict().items(), source_state.items()):
#         if 'bn' in k2:
#             continue
...
def load_weights_sequential(target, source_state):
    ...
    #         continue
    #     new_dict[k1] = v2
    target.state_dict().update(pretrained_dict)
...
class DenseNet(nn.Module):
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        #self.t1 = nn.Conv2d(3, num_init_features, kernel_size=7, stride=2, padding=3, bias=False)
        # Each denseblock
